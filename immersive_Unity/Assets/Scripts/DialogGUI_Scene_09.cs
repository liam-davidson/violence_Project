...
public class DialogGUI_Scene_09 : MonoBehaviour {
	...
	private CharacterInteract_Scene_09 state;
	private Vector3 scale;
	private CharacterResponses_Scene_09 response;
	...
	void Start(){
		state = gameObject.GetComponent<CharacterInteract_Scene_09>();
		response = GetComponent<CharacterResponses_Scene_09>();
		responseNum = 0;
