...
public class DialogGUI_Scene_06 : MonoBehaviour {
	...
	private CharacterInteract_Scene_06 state;
	private Vector3 scale;
	private CharacterResponses_Scene_06 response;
	...
	void Start(){
		state = gameObject.GetComponent<CharacterInteract_Scene_06>();
		response = GetComponent<CharacterResponses_Scene_06>();
		responseNum = 0;
