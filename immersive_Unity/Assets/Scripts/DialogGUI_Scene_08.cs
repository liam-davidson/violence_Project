...
public class DialogGUI_Scene_08 : MonoBehaviour {
	...
	private CharacterInteract_Scene_08 state;
	private Vector3 scale;
	private CharacterResponses_Scene_08 response;
	...
	void Start(){
		state = gameObject.GetComponent<CharacterInteract_Scene_08>();
		response = GetComponent<CharacterResponses_Scene_08>();
		responseNum = 0;
