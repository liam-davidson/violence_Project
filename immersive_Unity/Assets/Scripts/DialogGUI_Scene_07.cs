...
public class DialogGUI_Scene_07 : MonoBehaviour {
	...
	private CharacterInteract_Scene_07 state;
	private Vector3 scale;
	private CharacterResponses_Scene_07 response;
	...
	void Start(){
		state = gameObject.GetComponent<CharacterInteract_Scene_07>();
		response = GetComponent<CharacterResponses_Scene_07>();
		responseNum = 0;
